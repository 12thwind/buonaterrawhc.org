...
(function() {
	...
	// Initialize "On Visible" animations.
		onvisible.add('.image-component.style-1', { style: 'focus-image', speed: 1500, intensity: 7, threshold: 5, delay: 0, replay: false });
		onvisible.add('.form-component.style-1', { style: 'fade-up', speed: 1000, intensity: 1, threshold: 3, delay: 0, replay: false });
		onvisible.add('.icons-component.style-1', { style: 'fade-up', speed: 625, intensity: 1, threshold: 3, delay: 0, stagger: 125, staggerSelector: ':scope > li', replay: false });
